...
dir.create("4_predict/out/spatial_res/RF_dynamic",showWarnings = FALSE)
dir.create("4_predict/out/monthly_res",showWarnings = FALSE)
dir.create("4_predict/out/monthly_res/RF_static",showWarnings = FALSE)
dir.create("4_predict/out/monthly_res/RF_min_static",showWarnings = FALSE)
dir.create("4_predict/out/monthly_res/RF_static_dynamic",showWarnings = FALSE)
dir.create("4_predict/out/monthly_res/RF_min_static_dynamic",showWarnings = FALSE)
dir.create("4_predict/out/monthly_res/RF_dynamic",showWarnings = FALSE)
dir.create("4_predict/out/annual_res",showWarnings = FALSE)
dir.create("4_predict/out/annual_res/RF_static",showWarnings = FALSE)
dir.create("4_predict/out/annual_res/RF_min_static",showWarnings = FALSE)
