...
p3_targets_list <- list(
  ...
  tar_target(
    ...
    plot_ecdf(model_results = p3_model_results_random, 
              ...
              fileout = "3_visualize/out/ecdf_all_reaches_random.png",
              log_x_axis = TRUE,
              plot_points = FALSE,
  ...
  tar_target(
    ...
    plot_ecdf(model_results = p3_model_results_temporal, 
              plot_type = "all_reaches", 
              fileout = "3_visualize/out/ecdf_all_reaches_temporal.png",
              log_x_axis = TRUE,
              plot_points = FALSE,
              plot_width_in = 6, plot_height_in = 4),
    repository = "local",
  ...
  tar_target(
    ...
    plot_ecdf(model_results = p3_model_results_spatial, 
              plot_type = "all_reaches", 
              fileout = "3_visualize/out/ecdf_all_reaches_spatial.png",
              log_x_axis = TRUE,
              plot_points = FALSE,
              plot_width_in = 6, plot_height_in = 4),
    repository = "local",
